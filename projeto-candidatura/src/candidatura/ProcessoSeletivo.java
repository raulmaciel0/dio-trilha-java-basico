...
public class ProcessoSeletivo {
	...
	static void entrarEmContato(String candidato) {
		...
		if (atendeu) {
			...
			System.out.println("Não conseguimos contato com " + candidato + ", numeros maximo de tentativas atingido");
		}
	...
	static void analisarCandidato(double salarioPretendido) {
		...
		if (salarioBase > salarioPretendido) {
			...
			System.out.println("Ligando para fazer uma contraproposta....");
		}
		else {
			System.out.println("Aguardando lista de candidatos");
		}
	}
